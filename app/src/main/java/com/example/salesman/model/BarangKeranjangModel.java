...
public class BarangKeranjangModel {
    private int id_kranjang;
    ...
    public BarangKeranjangModel(int id_kranjang, int id_barang, String nama_barang, String keterangan, int harga_barang, int id_kategori, String jml_barang, String id_costumer, String foto_barang, String hargaSementara) {
        this.id_kranjang = id_kranjang;
    ...
    public int getId_kranjang() {
        return id_kranjang;
    }

    public void setId_kranjang(int id_kranjang) {
        this.id_kranjang = id_kranjang;
    }
